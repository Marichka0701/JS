...
// let btnModal = document.getElementById('btnModel');
...
formCheckbox.onchange = function () {
    let filteredUsersWithAddress = usersWithAddress.filter(value => {
        if (formCheckbox.filterFalse.checked && formCheckbox.filterAge.checked && formCheckbox.filterCity.checked) {
            return value.status === false && value.age > 29 && value.address.city === 'Kyiv';
        } else if (formCheckbox.filterFalse.checked && formCheckbox.filterAge.checked) {
            return value.status === false && value.age > 29;
        } else if (formCheckbox.filterFalse.checked && formCheckbox.filterCity.checked) {
            return value.status === false && value.address.city === 'Kyiv';
        } else if (formCheckbox.filterAge.checked && formCheckbox.filterCity.checked) {
            return value.age > 29 && value.address.city === 'Kyiv';
        } else if (formCheckbox.filterFalse.checked) {
            return value.status === false;
        } else if (formCheckbox.filterCity.checked) {
            return value.address.city === 'Kyiv';
        } else if (formCheckbox.filterAge.checked) {
            return value.age > 29;
        }
        return false;
    });
    ...
    displayObj(filteredUsersWithAddress);
};
...
// let formCheckbox = document.forms.checkbox;
// formCheckbox.onchange = function () {
//     let filteredUsers = usersWithAddress.filter(value => {
//         if (formCheckbox.filterFalse.checked && formCheckbox.filterAge.checked && formCheckbox.filterCity.checked) {
//             return value.status === false && value.age > 29 && value.address.city === 'Kyiv';
//         } else if (formCheckbox.filterFalse.checked && formCheckbox.filterAge.checked) {
//             return value.status === false && value.age > 29;
...
// formCheckbox.onchange = function (e) {
//     // console.log(formCheckbox.filterFalse.value);
//     if (formCheckbox.filterFalse.checked && formCheckbox.filterAge.checked) {
//         let filteredUsersByFalseAndAge = usersWithAddress.filter(value => value.status === false && value.age > 29);
//         displayObj(filteredUsersByFalseAndAge);
//         divContainer = "";
//     }
//     if (formCheckbox.filterFalse.checked && formCheckbox.filterCity.checked) {
//         let filteredUsersByFalseAndCity = usersWithAddress.filter(value => value.status === false && value.address.city === 'Kyiv');
//         displayObj(filteredUsersByFalseAndCity);
//         divContainer = "";
//     }
//     if (formCheckbox.filterFalse.checked && formCheckbox.filterCity.checked && formCheckbox.filterAge) {
//         let filteredUsersByFalseAndCityAndAge = usersWithAddress.filter(value => value.status === false && value.address.city === 'Kyiv' && value.age > 29);
//         displayObj(filteredUsersByFalseAndCity);
//         divContainer = "";
//     }
// }
